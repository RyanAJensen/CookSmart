...
export default function AddCustomIngredient({ visible, onDismiss, initialName = '' }: AddCustomIngredientProps) {
    ...
    if (name.trim()) {
      const ingredient = {
        ...
        nutrition: {
          ...
          servingSize: parseFloat(nutrition.servingSize) || 100,
  ...
  return (
    <Portal>
      ...
      >
        <ScrollView>
          <Text variant="headlineSmall" style={styles.title}>Add Custom Ingredient</Text>
          ...
          <Text variant="titleMedium" style={styles.sectionTitle}>Nutrition Information</Text>
