# 🧠 Smart Pantry Management & Recipe Discovery
...
This project was developed entirely with the assistance of AI tools such as Cursor and ChatGPT, including code generation, design, and documentation support.
